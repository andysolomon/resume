...
Life-time Student, Computational Scientist & andrewsolomon.edu@gmail.com \\

Atlanta, GA, 30324 & andysolomong.github.com / 678-613-5631\\
...
\item
	...
	\begin{itemize}
		...
		\resitem{Graduated Cum Laude with minors in Business and Mathematics}
...
\item {\bf Development:} Python (Django), JavaScript (Nodejs, Geddy, Backbone), Ruby (Rails, Sinatra), PHP (Codeigniter)

\item {\bf Mathematics:} Optimization, Linear Algebra, Computational Physics, Complex Systems, Tomology
...
\item {\bf Hobbies:} Poker, Swimming, Running, Video Games, Building things (physical and/or digital) and drinking good beer new and old friends.
