...
Atlanta, GA & andysolomong.github.com / 678-613-5631\\
...
\item {\bf Javascript:} Development (jQuery, Backbone, Express, Geddy, jQuery Mobile), Testing/Configuration (Jasmine, JSLint, Require)

\item {\bf Ruby:} Development (Rails, Sinatra, Jekyll, Mruby), Testing/Configuration (Rspec, Cucumber, Bundler, Rake)

\item {\bf PHP:} Development (Codeigniter, Wordpress)

\item {\bf HTML/CSS:} Development (HAML, SASS, LESS, Canvas, WebSockets), Testing/Configuration (Compass)
